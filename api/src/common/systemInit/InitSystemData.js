...
async function initData() {
    ...
    try {
        ...
        const systemMenu = await Sys_Menu.create({ name: '系统配置', menuType: '1', menuTypeDesc: '导航路由', icon: 'setting', parentId: 0, treeId: '[0]', isLeaf: '0', sort: 3 }, { transaction: trans })
        ...
        const menu4 = await Sys_Menu.create({ name: '菜单管理', menuType: '1', menuTypeDesc: '导航路由', menuLink: '/systemSetting/menu/menuHome', comPath: '/system/menu/menuHome.js', parentId: systemMenu.id, treeId: `[0],[${systemMenu.id}]`, isLeaf: '1', sort: 1 }, { transaction: trans });
        const menu5 = await Sys_Menu.create({ name: 'api管理', menuType: '1', menuTypeDesc: '导航路由', menuLink: '/systemSetting/apiManage/apiManageHome', comPath: '/system/apiManage/apiManageHome.js', parentId: systemMenu.id, treeId: `[0],[${systemMenu.id}]`, isLeaf: '1', sort: 2 }, { transaction: trans });
